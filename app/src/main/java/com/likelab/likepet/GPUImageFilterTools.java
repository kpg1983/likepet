...
import com.likelab.likepet.filter.IF1977Filter;
...
import com.likelab.likepet.filter.IFNashvilleFilter;
import com.likelab.likepet.filter.IFRiseFilter;
import com.likelab.likepet.filter.IFSierraFilter;
import com.likelab.likepet.filter.IFSutroFilter;
import com.likelab.likepet.filter.IFToasterFilter;
import com.likelab.likepet.filter.IFValenciaFilter;
import com.likelab.likepet.filter.IFWaldenFilter;
import com.likelab.likepet.filter.IFXprollFilter;
...
//
    ...
    private static void chooseFilter(final Context context, final int item) {
