 ...
 */
public class FollowingContentsAdapter extends BaseAdapter{
    ...
    public FollowingContentsAdapter (Context mContext,int mLayout, ArrayList<FollowingContents> contentsArrayList) {
        ...
        handler = new Handler();
        followingCount = contentsArrayList.size();
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        contentsArrayList.get(position).friendFlag = 1;
        userId = contentsArrayList.get(position).userId;
        ...
        btnFriendAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (contentsArrayList.get(position).friendFlag == 1) {
                    contentsArrayList.get(position).friendFlag = 0;
