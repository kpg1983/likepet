 ...
 */
public class FollowingUserListActivity extends Activity {
    ...
    FollowingContentsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FollowingContentsAdapter(FollowingUserListActivity.this, R.layout.following_user_list_view, contentsArrayList);
    ...
    public void loadFollowingRequest(int pageNo) {
        ...
        String endPoint = "/mypage/following";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (responseCode == 200) {
                                ...
                                following = response.getJSONObject("following");
                                ...
                                for(int i=0; i< users.length(); i++) {
                                    ...
                                    userId = users.getJSONObject(i).getString("followingUserId");
                                    ...
                                    FollowingContents contents = new FollowingContents(userId, profileImageUrl, name, clan, gender);
    ...
    public void loadOtherFollowingRequest(String userId, int pageNo) {
        ...
        String endPoint = "/otherpage/" + userId + "/following";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (responseCode == 200) {
                                ...
                                //FollowingContentsAdapter adapter = new FollowingContentsAdapter(FollowingUserListActivity.this, R.layout.following_user_list_view, contentsArrayList);
